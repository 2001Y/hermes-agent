                  ...
                  <div className="border-t border-border bg-background/50 p-4 grid gap-3">
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                      {editing ? (
                        ...
                        <Button size="sm" outlined onClick={() => onStartEdit(entry)} className="gap-1.5">
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex items-center justify-between gap-4 flex-wrap">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <Badge tone="secondary" className="text-xs">{totalEntries} {t.memory.entryCount}</Badge>
        </div>
        <Button size="sm" outlined className="gap-1.5" onClick={() => void load()}>
